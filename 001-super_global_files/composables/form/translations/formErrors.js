const formErrors = () => {
  ...
  const captchaErr = {
    id: 10,
    en: "Recaptcha error in google (score)",
    it: "Recaptcha error in google (score)",
    tr: "Recaptcha error in google (score)",
    ro: "Recaptcha error in google (score)",
    hu: "Recaptcha error in google (score)",
    ar: "Recaptcha error in google (score)",
    de: "Recaptcha error in google (score)",
    es: "Recaptcha error in google (score)",
    sv: "Recaptcha error in google (score)",
    pt: "Recaptcha error in google (score)",
    fi: "Recaptcha error in google (score)",
    pl: "Recaptcha error in google (score)",
    th: "Recaptcha error in google (score)",
    ms: "Recaptcha error in google (score)",
  };
