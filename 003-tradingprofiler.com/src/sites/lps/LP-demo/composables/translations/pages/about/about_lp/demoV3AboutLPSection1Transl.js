const aboutLPSection1Transl = () => {
  const title = {
    en: "Demo v3 - About LP",
    it: "Demo v3 - Di LP",
    tr: "Demo v3 - Hakkında LP",
    ro: "Demo v3 - Despre LP",
    hu: "Demo v3 - Ról ről LP",
    ar: "Demo v3 - عن LP",
    de: "Demo v3 - Etwa LP",
    es: "Demo v3 - Acerca de LP",
    sv: "Demo v3 - Handla om LP",
    pt: "Demo v3 - Cerca de LP",
    fi: "Demo v3 - Noin LP",
    pl: "Demo v3 - O LP",
    th: "Demo v3 - เกี่ยวกับ LP",
    ms: "Demo v3 - Tentang LP",
  };
