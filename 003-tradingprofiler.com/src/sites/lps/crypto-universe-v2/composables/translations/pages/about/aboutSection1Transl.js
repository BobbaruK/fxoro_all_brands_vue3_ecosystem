const aboutSection1Transl = () => {
  const title = {
    en: "CryptoUniverse - About",
    it: "CryptoUniverse - Di",
    tr: "CryptoUniverse - Hakkında",
    ro: "CryptoUniverse - Despre",
    hu: "CryptoUniverse - Ról ről",
    ar: "CryptoUniverse - عن",
    de: "CryptoUniverse - Etwa",
    es: "CryptoUniverse - Acerca de",
    sv: "CryptoUniverse - Handla om",
    pt: "CryptoUniverse - Cerca de",
    fi: "CryptoUniverse - Noin",
    pl: "CryptoUniverse - O",
    th: "CryptoUniverse - เกี่ยวกับ",
    ms: "CryptoUniverse - Tentang",
  };
