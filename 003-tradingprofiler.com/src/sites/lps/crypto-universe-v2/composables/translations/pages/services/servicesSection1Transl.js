const servicesSection1Transl = () => {
  const title = {
    ...
    en: "CryptoUniverse - Services",
    it: "CryptoUniverse - Services",
    tr: "CryptoUniverse - Services",
    ro: "CryptoUniverse - Services",
    hu: "CryptoUniverse - Services",
    ar: "CryptoUniverse - Services",
    de: "CryptoUniverse - Services",
    es: "CryptoUniverse - Services",
    sv: "CryptoUniverse - Services",
    pt: "CryptoUniverse - Services",
    fi: "CryptoUniverse - Services",
    pl: "CryptoUniverse - Services",
    th: "CryptoUniverse - Services",
    ms: "CryptoUniverse - Services",
  };
