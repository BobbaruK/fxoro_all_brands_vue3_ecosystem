...
import goldSection3Transl from "../../composables/translations/pages/home/goldSection3Transl";

export default {
  name: "LP~GoldV2~Home~Section3",
  emits: ["showForm"],
  props: {
    lang: String,
  },
  setup(_, ctx) {
    ...
    // Translations
    const { bullet1, bullet2, bullet3, bullet4 } = goldSection3Transl();
        ...
        <div class="col-12 bulletsWrapper">
          <transition appear @before-enter="onBeforeEnterPara" @enter="onEnterPara">
            <div class="bulletsInner">
              <div class="icon">
                <img src="../../assets/imgs/section3/icon1.svg" :alt="bullet1.title[lang]" width="150" height="150" />
              </div>
              <div class="content">
          ...
          <transition appear @before-enter="onBeforeEnterPara" @enter="onEnterPara">
            <div class="bulletsInner">
              <div class="icon">
                <img src="../../assets/imgs/section3/icon2.svg" :alt="bullet2.title[lang]" width="150" height="150" />
              </div>
              <div class="content">
          ...
          <transition appear @before-enter="onBeforeEnterPara" @enter="onEnterPara">
            <div class="bulletsInner">
              <div class="icon">
                <img src="../../assets/imgs/section3/icon3.svg" :alt="bullet3.title[lang]" width="150" height="150" />
              </div>
              <div class="content">
          ...
          <transition appear @before-enter="onBeforeEnterPara" @enter="onEnterPara">
            <div class="bulletsInner">
              <div class="icon">
                <img src="../../assets/imgs/section3/icon4.svg" :alt="bullet4.title[lang]" width="150" height="150" />
              </div>
              <div class="content">
