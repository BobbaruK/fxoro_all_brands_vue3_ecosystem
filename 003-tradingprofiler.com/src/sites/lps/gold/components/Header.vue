  ...
  <header id="header" class="siteHeader">
    <div class="row">
      <div class="col-6 logoColumn">
        <router-link v-if="route.name === 'GoldV1Home'" :to="{ name: 'GoldV1Home', params: { lang: lang } }">
          <img
        ...
        <router-link v-else-if="route.name === 'GoldV2Home'" :to="{ name: 'GoldV2Home', params: { lang: lang } }">
          <img
            src="../../../brand/assets/imgs/logos/TradingProfilerLogo-color-white.svg"
            alt="Logo"
            class="logo"
